   ...
   <div class="card-body">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
                  ...
                  <article class="px-3">
                    <p>{{ $faculty->birthday }}</p>
                    <p>{{ $faculty->yearlevel }}</p>
                    <p>{{ $faculty->course_strand }}</p>
                    <p>{{ $faculty->section_block }}</p>
                    ...
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                      <div class="accordion-item shadow mb-3">
                        ...
                        <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                          <div class="accordion-body">{{ $faculty->goal }}</div>
                        </div>
                      </div>
                      <div class="accordion-item shadow mb-3">
                        ...
                        <div id="flush-collapseTwo" class="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                          <div class="accordion-body">{{ $faculty->motto }}</div>
                        </div>
                      </div>

                      @if (!empty($faculty->awards))
                      <div class="accordion-item shadow mb-3">
                        ...
                        <div id="flush-collapseThree" class="accordion-collapse collapse" aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                          <div class="accordion-body">{{ $faculty->awards }}</div>
                        </div>
                      </div>
                      @endif
                    </div>
